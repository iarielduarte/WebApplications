...
$(document).ready(function() {
 var activarAlternadorEstilo = function() {
 $('#alternador .boton').toggleClass('ocultar');
 };

 $('#alternador').click(activarAlternadorEstilo);

 $('#alternador-normal').click(function() {
 $('#alternador').click(activarAlternadorEstilo);
 });
 $('#alternador-estrecho, #alternador-largo').click(function() {
 $('#alternador').unbind('click', activarAlternadorEstilo);
 });
});
...
/*$(document).ready(function() {
  $('#alternador').one('click', activarAlternadorEstilo);
});*/
